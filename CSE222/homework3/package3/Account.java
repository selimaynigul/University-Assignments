...
public class Account 
{
    ...
    public Account(int accountId, String username, String birthdate, String location) {
        ...
        this.inbox = new LDLinkedList<>();
        this.outbox = new LDLinkedList<>();
    ...
    public void viewPosts(Account account) {
            ...
            System.out.println("----------------------------");
            LDLinkedList<Post> posts = account.getPosts();
            if (posts.size() == 0) {
     ...
     */
    public void viewInteractions(Account account, LDLinkedList<Account> accounts) {    
        ...
        for(int i = 1; i <= posts.size(); i++) {
            ...
            if(posts.get(i - 1).getLikeCount() == 0)
                ...
                LDLinkedList<Like> likes = posts.get(i - 1).getLikes();
            ...
            LDLinkedList<Comment> comments = posts.get(i - 1).getComments();
     ...
     * @param accounts will be checked to print senders' usernames
     */
    public void viewInbox(LDLinkedList<Account> accounts) {
