...
public class Account 
{
     ...
     */
    public void viewInteractions(Account account, LinkedList<Account> accounts) {    
        ...
        for(int i = 1; i <= posts.size(); i++) {
            ...
            if(posts.get(i - 1).getLikeCount() == 0)
                ...
                LinkedList<Like> likes = posts.get(i - 1).getLikes();
            ...
            LinkedList<Comment> comments = posts.get(i - 1).getComments();
     ...
     * @param accounts will be checked to print senders' usernames
     */
    public void viewInbox(LinkedList<Account> accounts) {
